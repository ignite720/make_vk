    ...
    with open(input_file_path, mode="r") as fp:
        ...
        for i in range(0, len(lines)):
            ...
            if re.search(r"VkStructureType\s+sType;\s*$", line):
                ...
                output_lines_for_test.append(f"{struct_name} tmp = MAKE_{struct_name_snake_case_with_parenthesis};\n    REQUIRE(tmp.sType == {struct_name_snake_case_vk_type});")
    ...
    if VULKAN_SDK:
        ...
        if True:
            ...
            with open(output_file_path, mode="w", encoding="utf-8", newline="\n") as fp:
                ...
                content += "\n"
                content += f"// {len(output_lines_c)} Entries\n"
                ...
                content += "#else\n"
                content += "\n"
                content += "#if __cplusplus >= 202002L\n"
                content += "\n"
        ...
        if True:
            ...
            with open(output_test1_file_path, mode="w", encoding="utf-8", newline="\n") as fp:
                ...
                content += "\n"
                content += "#if defined(MAKE_VK_USE_CATCH2)\n"
